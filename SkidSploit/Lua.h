...
typedef int(__stdcall*Typedef_GetMetaTable)(int L, int idx);
...
void PCall(int a1, int a2, int a3, int a4) {
	//BypassPen(); // Bypasses PenVCheck roblox removed should still work fine.
	Pcall_Function(a1, a2, a3, a4);
	//RestorePen(); // Restores PenVCheck roblox removed should still work fine.
}
